...
<node TEXT="Cliccando su un link del tipo (mailto:don.bonton@supermail.com) verr&#xe0; aperto il programma impostato di default per inviare posta (es.Outlook) per creare un nuovo messaggio." ID="ID_1282579924" CREATED="1124560950732" MODIFIED="1281277343546" LINK="mailto:don.bonton@supermail.com">
<font NAME="SansSerif" SIZE="12"/>
</node>
<node TEXT="E&apos; possibile impostare anche l&apos;oggetto della mail nel link: es.mailto:don.bonton@supermail.com?subject=Ultima telefonata." ID="ID_502426887" CREATED="1124560950732" MODIFIED="1265113584905" LINK="mailto:don.bonton@supermail.com?subject=Last%20phone%20call"/>
