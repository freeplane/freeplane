...
public class NodeModel{
	...
	void setClones(Clones clones) {
		...
		for(NodeModel clone : clones)
			clone.fireNodeChanged(new NodeChangeEvent(this, NodeModel.UNKNOWN_PROPERTY, null, null, true, false, false));
	}
	...
	public void setFolded(boolean folded) {
		...
		fireNodeChanged(new NodeChangeEvent(this, NodeChangeType.FOLDING, Boolean.valueOf(wasFolded), Boolean.valueOf(folded), true, false, false));
	}
