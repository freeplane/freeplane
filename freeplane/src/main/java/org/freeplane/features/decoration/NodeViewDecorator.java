...
public class NodeViewDecorator
{
	...
	public NodeViewDecorator(LinkDecorationConfig decorationConfig)
	{
		setDecorationConfig(decorationConfig);
	}

	public LinkDecorationConfig getDecorationConfig()
	{
	...
	public void setDecorationConfig(LinkDecorationConfig decorationConfig)
	{
