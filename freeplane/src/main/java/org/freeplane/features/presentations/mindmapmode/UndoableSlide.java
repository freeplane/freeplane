...
class UndoableSlide {
	...
	private UndoableSlide(ModeController controller, MapModel mapModel, Slide slide) {
		super();
    ...
    public void setRootNodeId(final String rootNodeId) {
        final String oldRootNodeId = slide.getRootNodeId();
        if(rootNodeId == oldRootNodeId ||rootNodeId != null && rootNodeId.equals(oldRootNodeId))
            return;
        IActor actor = new IActor() {
            ...
            @Override
            public void act() {
                slide.setRootNodeId(rootNodeId);
            }

            @Override
            public void undo() {
                slide.setRootNodeId(oldRootNodeId);
            }
