	...
	public void actionPerformed(final ActionEvent e) {
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
			...
			try {
				...
				((MLinkController) LinkController.getController(MModeController
				    .getMModeController())).setLink(node, linkToNewMapString);
			}
			catch (final MalformedURLException ex) {
			...
			try {
				...
				((MLinkController) LinkController.getController(MModeController
				    .getMModeController())).setLink(newNode, linkString);
			}
			catch (final MalformedURLException ex) {
				Tools.logException(ex);
			}
