...
public class NodeMotionListenerView extends JComponent {
	...
	public NodeMotionListenerView(final NodeView view) {
		super();
		movedView = view;
		final IUserInputListenerFactory userInputListenerFactory = view
		    .getMap().getModeController().getUserInputListenerFactory();
		...
		final String helpMsg = Freeplane.getController()
		    .getResourceController().getResourceString("node_location_help");
