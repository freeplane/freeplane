...
public class EnterPasswordDialog extends JDialog {
	...
	private JButton getJCancelButton() {
		if (jCancelButton == null) {
			...
			jCancelButton.setText(TextUtil.getText("accessories/plugins/EncryptNode.properties_7"));
		}
	...
	private javax.swing.JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabel.setText(TextUtil.getText("accessories/plugins/EncryptNode.properties_2"));
			gridBagConstraints2.gridx = 0;
			gridBagConstraints2.gridy = 2;
			gridBagConstraints2.fill = java.awt.GridBagConstraints.HORIZONTAL;
			jLabel1.setText(TextUtil.getText("accessories/plugins/EncryptNode.properties_3"));
			...
			jLabel2.setText(TextUtil.getText("accessories/plugins/EncryptNode.properties_4"));
			jLabel2.setToolTipText(TextUtil.getText("accessories/plugins/EncryptNode.properties_5"));
	...
	private JButton getJOKButton() {
		if (jOKButton == null) {
			...
			jOKButton.setText(TextUtil.getText("accessories/plugins/EncryptNode.properties_6"));
		}
		return jOKButton;
	}
	...
	private void initialize() {
		this.setTitle(TextUtil.getText("accessories/plugins/EncryptNode.properties_0"));
	...
	private void okPressed() {
		if (!checkEqualAndMinimumSize()) {
			JOptionPane.showMessageDialog(this, TextUtil.getText("accessories/plugins/EncryptNode.properties_1"));
			return;
		}
