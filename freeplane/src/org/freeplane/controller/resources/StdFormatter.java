...
class StdFormatter extends SimpleFormatter {
	 ...
	 */
	final static Level STDERR = new StdOutErrLevel("STDERR", Level.SEVERE
	    .intValue() + 53);
	/**
	 * Level for STDOUT activity.
	 */
	final static Level STDOUT = new StdOutErrLevel("STDOUT", Level.WARNING
	    .intValue() + 53);
