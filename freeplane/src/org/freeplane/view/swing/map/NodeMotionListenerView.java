...
public class NodeMotionListenerView extends JComponent {
	...
	public NodeMotionListenerView(final NodeView view) {
		super();
		movedView = view;
		final IUserInputListenerFactory userInputListenerFactory = view.getMap().getModel().getModeController().getUserInputListenerFactory();
		...
		final String helpMsg = Controller.getText("node_location_help");
