 ...
 * 
 * @see org.freeplane.io.xml.n3.nanoxml.XMLElement
...
class XMLAttribute {
	 ...
	 *            the type of the attribute
	 */
	XMLAttribute(final String fullName, final String name,
	             final String namespace, final String value, final String type) {
