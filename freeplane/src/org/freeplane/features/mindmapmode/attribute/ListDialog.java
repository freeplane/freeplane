...
class ListDialog extends JDialog {
	...
	private ListDialog(final Frame frame, final Component locationComp, final String labelText, final String title,
		...
		MenuBuilder.setLabelAndMnemonic(closeButton, FreeplaneResourceBundle.getByKey("close"));
		closeButton.addActionListener(new CloseAction());
		getRootPane().setDefaultButton(closeButton);
		addButton = new JButton();
		MenuBuilder.setLabelAndMnemonic(addButton, FreeplaneResourceBundle.getByKey("add"));
		final AddAction addAction = new AddAction();
		addButton.addActionListener(addAction);
		renameButton = new JButton();
		MenuBuilder.setLabelAndMnemonic(renameButton, FreeplaneResourceBundle.getByKey("rename"));
		renameButton.addActionListener(new RenameAction());
		deleteButton = new JButton();
		MenuBuilder.setLabelAndMnemonic(deleteButton, FreeplaneResourceBundle.getByKey("delete"));
