...
downloadJRE:
  ...
  ${If} ${RunningX64}
    DetailPrint "About to download JRE from ${JRE_URL_64}"
    NSISdl::download "${JRE_URL_64}" "$TEMP\jre_Setup.exe"
  ${Else}
    DetailPrint "About to download JRE from ${JRE_URL_32}"
    NSISdl::download "${JRE_URL_32}" "$TEMP\jre_Setup.exe"
  ${EndIf}
