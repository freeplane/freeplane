 ...
 * 19.12.2012
 */
public class GenericFreeplaneScript implements IFreeplaneScript {
	...
	public GenericFreeplaneScript(String script, String scriptEngineName, ScriptingPermissions permissions) {
	    super();
	    this.script = script;
	...
	public GenericFreeplaneScript(String script, String scriptEngineName){
    ...
    private Bindings createBinding(final NodeModel node) {
	    ...
	    binding.put("cookies", GenericFreeplaneScript.sScriptCookies);
	    return binding;
    }
	...
	private CompiledScript compile() throws Throwable {
 	...
 	private void handleGroovyRuntimeException(final ScriptException e) {
