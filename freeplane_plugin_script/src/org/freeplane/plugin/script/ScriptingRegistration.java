...
class ScriptingRegistration implements IRibbonContributorFactory {
...
//			modeController.getUserInputListenerFactory().getMenuBuilder(RibbonBuilder.class).registerContributorFactory("main_menu_scripting", this);
//			modeController.getUserInputListenerFactory().getMenuBuilder(RibbonBuilder.class).updateRibbon(ScriptingRegistration.class.getResource("ribbons.xml"));
