...
Source: {%USERPROFILE}\.freeplane\*; DestDir: {userappdata}\Freeplane; Flags: uninsneveruninstall external skipifsourcedoesntexist recursesubdirs onlyifdoesntexist; Tasks: ; Languages: 
