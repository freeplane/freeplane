...
[Registry]
Root: HKCR; Subkey: .mm; ValueType: string; ValueData: Freeplane; Flags: uninsdeletevalue; Tasks: associate
...
Root: HKCR; Subkey: Freeplane; ValueType: string; ValueData: Freeplane; Flags: uninsdeletekey; Tasks: associate
;"My Program File" above is the name for the file type as shown in Explorer.
Root: HKCR; Subkey: Freeplane\DefaultIcon; ValueType: string; ValueData: {app}\freeplane.exe,1; Tasks: associate
;"DefaultIcon" is the registry key that specifies the filename containing the icon to associate with the file type. ",0" tells Explorer to use the first icon from MYPROG.EXE. (",1" would mean the second icon.)
Root: HKCR; Subkey: Freeplane\shell\open\command; ValueType: string; ValueData: """{app}\freeplane.exe ""%1"""; Tasks: associate
