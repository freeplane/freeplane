...
set defines= "-Dorg.freeplane.param1=%1" "-Dorg.freeplane.param2=%2" "-Dorg.freeplane.param3=%3" "-Dorg.freeplane.param4=%4" "-Dorg.freeplane.userfpdir=%appdata%\Freeplane"
