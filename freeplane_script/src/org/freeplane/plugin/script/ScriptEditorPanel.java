...
class ScriptEditorPanel extends JDialog {
	...
	public ScriptEditorPanel(final Controller controller, final IScriptModel pScriptModel,
		...
		MenuBuilder.setLabelAndMnemonic(menu, Controller.getText("plugins/ScriptEditor.menu_actions"));
		if (pHasNewScriptFunctionality) {
			addAction(menu, new NewScriptAction(Controller.getText("plugins/ScriptEditor.new_script")));
		}
		mRunAction = new RunAction(Controller.getText("plugins/ScriptEditor.run"));
		mRunAction.setEnabled(false);
		addAction(menu, mRunAction);
		mSignAction = new SignAction(controller, Controller.getText("plugins/ScriptEditor.sign"));
		mSignAction.setEnabled(false);
		addAction(menu, mSignAction);
		final AbstractAction cancelAction = new CancelAction(Controller.getText("plugins/ScriptEditor.cancel"));
		addAction(menu, cancelAction);
		final AbstractAction exitAction = new ExitAction(Controller.getText("plugins/ScriptEditor.exit"));
