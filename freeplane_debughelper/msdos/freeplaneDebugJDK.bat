...
@echo on
"C:\Program Files\Java\jdk1.8.0_60\bin\java" -Xdebug -Xrunjdwp:transport=dt_socket,address=1044,server=y,suspend=y -XX:MaxRAM=20g -XX:MaxRAMPercentage=15 -jar freeplanelauncher.jar
